...
void GrpcResponseHandler::handle(GrpcClient::Response<GrpcClient::TxStatus> response)
{
...
void GrpcResponseHandler::handle(GrpcClient::Response<iroha::protocol::QueryResponse> response)
{
    if (response.status.ok())
    {
