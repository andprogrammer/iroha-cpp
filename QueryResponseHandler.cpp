...
QueryResponseHandler::QueryResponseHandler(logger::LoggerPtr log): log_(std::move(log))
{
    ...
    handler_map_[QueryResponse::ResponseCase::kAccountResponse] = &QueryResponseHandler::handleAccountResponse;
    handler_map_[QueryResponse::ResponseCase::kAccountAssetsResponse] = &QueryResponseHandler::handleAccountAssetsResponse;
    handler_map_[QueryResponse::ResponseCase::kSignatoriesResponse] = &QueryResponseHandler::handleSignatoriesResponse;
    handler_map_[QueryResponse::ResponseCase::kTransactionsResponse] = &QueryResponseHandler::handleTransactionsResponse;
    handler_map_[QueryResponse::ResponseCase::kRolesResponse] = &QueryResponseHandler::handleRolesResponse;
    handler_map_[QueryResponse::ResponseCase::kRolePermissionsResponse] = &QueryResponseHandler::handleRolePermissionsResponse;
    handler_map_[QueryResponse::ResponseCase::kAssetResponse] = &QueryResponseHandler::handleAssetResponse;

    error_handler_map_[ErrorResponse::STATEFUL_INVALID] = "Query is stateful invalid";
    error_handler_map_[ErrorResponse::STATELESS_INVALID] = "Query is stateless invalid";
    error_handler_map_[ErrorResponse::NO_ACCOUNT] = "Account not found";
    error_handler_map_[ErrorResponse::NO_ACCOUNT_ASSETS] = "Account assets not found";
...
void QueryResponseHandler::handle(const iroha::protocol::QueryResponse &response)
{
...
void QueryResponseHandler::handleErrorResponse(const iroha::protocol::QueryResponse &response)
{
...
void QueryResponseHandler::handleAccountResponse(const iroha::protocol::QueryResponse &response)
{
...
void QueryResponseHandler::handleRolesResponse(const iroha::protocol::QueryResponse &response)
{
...
void QueryResponseHandler::handleRolePermissionsResponse(const iroha::protocol::QueryResponse &response)
{
    ...
    std::for_each(perms.begin(),
                  perms.end(),
                  [this](auto perm)
    {
        log_->info(prefix.at(kDefault),
                   shared_model::proto::permissions::toString(static_cast<shared_model::interface::permissions::Role>(perm)));
    });
}

void QueryResponseHandler::handleAccountAssetsResponse(const iroha::protocol::QueryResponse &response)
{
...
void QueryResponseHandler::handleSignatoriesResponse(const iroha::protocol::QueryResponse &response)
{
    auto signatories = response.signatories_response().keys();
    log_->info("[Signatories]");
    std::for_each(signatories.begin(),
                  signatories.end(),
                  [this](auto signatory)
    {
...
void QueryResponseHandler::handleTransactionsResponse(const iroha::protocol::QueryResponse &response)
{
